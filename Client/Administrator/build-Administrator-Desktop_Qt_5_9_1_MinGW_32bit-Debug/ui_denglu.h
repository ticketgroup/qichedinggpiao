...
public:
    ...
    void setupUi(QDialog *Denglu)
    {
        ...
        label_2->setGeometry(QRect(250, 60, 91, 31));
        QFont font;
        ...
        pushButton_2->setGeometry(QRect(290, 220, 75, 23));
        ...
        label->setGeometry(QRect(130, 30, 141, 41));
        QFont font2;
        ...
        pushButton_3->setGeometry(QRect(190, 220, 75, 23));
    ...
    void retranslateUi(QDialog *Denglu)
    {
        ...
        label_2->setText(QApplication::translate("Denglu", "\347\256\241\347\220\206\345\221\230\344\270\223\347\224\250", Q_NULLPTR));
