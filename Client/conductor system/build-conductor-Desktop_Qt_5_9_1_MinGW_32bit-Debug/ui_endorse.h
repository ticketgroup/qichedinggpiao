...
public:
    ...
    void setupUi(QDialog *Endorse)
    {
        ...
        Endorse->resize(573, 338);
        pushButton = new QPushButton(Endorse);
        pushButton->setObjectName(QStringLiteral("pushButton"));
        pushButton->setGeometry(QRect(390, 50, 75, 23));
        pushButton_2 = new QPushButton(Endorse);
        pushButton_2->setObjectName(QStringLiteral("pushButton_2"));
        pushButton_2->setGeometry(QRect(480, 50, 75, 23));
        ...
        tableWidget->setGeometry(QRect(0, 90, 571, 241));
        dateEdit = new QDateEdit(Endorse);
        dateEdit->setObjectName(QStringLiteral("dateEdit"));
        dateEdit->setGeometry(QRect(80, 50, 71, 21));
